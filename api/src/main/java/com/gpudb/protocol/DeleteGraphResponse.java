 ...
 */
public class DeleteGraphResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("DeleteGraphResponse")
            .namespace("com.gpudb")
            .fields()
    ...
    /**
     * @return Indicates a successful deletion.
     */
    ...
    /**
     * @param result Indicates a successful deletion.
     * @return {@code this} to mimic the builder pattern.
     */
    public DeleteGraphResponse setResult(boolean result) {
        this.result = result;
        return this;
    }
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public DeleteGraphResponse setInfo(Map<String, String> info) {
