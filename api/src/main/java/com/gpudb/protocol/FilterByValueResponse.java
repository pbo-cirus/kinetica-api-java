 ...
 */
public class FilterByValueResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("FilterByValueResponse")
            .namespace("com.gpudb")
            .fields()
    ...
    /**
     * @param count The number of records passing the value filter.
     * @return {@code this} to mimic the builder pattern.
     */
    public FilterByValueResponse setCount(long count) {
        this.count = count;
        return this;
    }
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public FilterByValueResponse setInfo(Map<String, String> info) {
    ...
    public boolean equals(Object obj) {
        ...
        FilterByValueResponse that = (FilterByValueResponse) obj;
