...
public class ShowResourceStatisticsRequest implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("ShowResourceStatisticsRequest")
            .namespace("com.gpudb")
            .fields()
     ...
     *                {@link Map}.
     */
    public ShowResourceStatisticsRequest(Map<String, String> options) {
     ...
     */
    public ShowResourceStatisticsRequest setOptions(Map<String, String> options) {
        this.options = (options == null) ? new LinkedHashMap<String, String>() : options;
        return this;
    }
