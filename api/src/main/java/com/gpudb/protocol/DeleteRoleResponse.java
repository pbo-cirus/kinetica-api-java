 ...
 */
public class DeleteRoleResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("DeleteRoleResponse")
            .namespace("com.gpudb")
            .fields()
     ...
     */
    public DeleteRoleResponse setName(String name) {
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public DeleteRoleResponse setInfo(Map<String, String> info) {
