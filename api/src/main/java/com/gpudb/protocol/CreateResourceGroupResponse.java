 ...
 */
public class CreateResourceGroupResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("CreateResourceGroupResponse")
            .namespace("com.gpudb")
            .fields()
     ...
     */
    public CreateResourceGroupResponse setName(String name) {
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public CreateResourceGroupResponse setInfo(Map<String, String> info) {
